...
export default function MainBar({setNotification, task}: MainbarProps){
    ...
    return(
        <div className="flex justify-between items-center gap-3 border w-8/12 p-6 rounded-sm m-5 mx-auto">
            ...
            <span className="flex items-center gap-3">
                ...
                <Stopwatch isStarted={isStarted} currentSeconds={task ? Math.floor((Date.now() - task.startTime.getTime()) / 1000) : undefined}/>
                <span className="border h-4 rounded-2xl border-gray-300 mx-2"></span>
