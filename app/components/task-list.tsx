...
export default function TaskList({ taskList, category, day }: { taskList: TaskType[] | undefined; category: CategoryType[]; day: string }) {
  ...
  return (
    <div className="m-5 mx-auto rounded-md border-2 border-gray-200">
      <div
        className="flex h-16 items-center justify-between rounded-sm bg-gray-50 hover:cursor-pointer max-sm:p-3 sm:p-6"
        onClick={handleListCollapseClick}
      >
        ...
        <div className="flex items-center justify-center">
          ...
          <div className="mx-2">
            {isListOpen ? <ChevronsDownUp size={18} className="relative bottom-px" /> : <ChevronsUpDown size={18} className="relative bottom-px" />}
          </div>
        </div>
      </div>
      {isListOpen && (
